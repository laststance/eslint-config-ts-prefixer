...
describe('CLI commands', () => {
  ...
  describe('setup command with ESLint v8', () => {
    it('should create all necessary configuration files', () => {
      execSync(
        `cd ${testDir} && echo "8" | node ${join(__dirname, '../bin/cli.mjs')} setup`,
        { stdio: 'pipe' },
      )
  ...
  describe('setup command with ESLint v9', () => {
    it('should create all necessary configuration files', () => {
      execSync(
        `cd ${testDir} && echo "9" | node ${join(__dirname, '../bin/cli.mjs')} setup`,
        { stdio: 'pipe' },
      )
  ...
  describe('full-copy command with ESLint v8', () => {
    it('should create all necessary configuration files', () => {
      execSync(
        `cd ${testDir} && echo "8" | node ${join(__dirname, '../bin/cli.mjs')} full-copy`,
        { stdio: 'pipe' },
      )
  ...
  describe('full-copy command with ESLint v9', () => {
    it('should create all necessary configuration files', () => {
      execSync(
        `cd ${testDir} && echo "9" | node ${join(__dirname, '../bin/cli.mjs')} full-copy`,
        { stdio: 'pipe' },
      )
  ...
  describe('standalone command with ESLint v8', () => {
    it('should create all necessary configuration files', () => {
      execSync(
        `cd ${testDir} && echo "8" | node ${join(__dirname, '../bin/cli.mjs')} standalone`,
        { stdio: 'pipe' },
      )
  ...
  describe('standalone command with ESLint v9', () => {
    it('should create all necessary configuration files', () => {
      execSync(
        `cd ${testDir} && echo "9" | node ${join(__dirname, '../bin/cli.mjs')} standalone`,
        { stdio: 'pipe' },
      )
